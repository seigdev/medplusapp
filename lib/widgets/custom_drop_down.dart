...
class CustomDropDown extends StatelessWidget {
  ...
  Widget get dropDownWidget => SizedBox(
        ...
        child: DropdownButtonFormField(
          ...
          icon: icon,
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.labelLargePrimaryContainer,
          items: items?.map<DropdownMenuItem<String>>((String value) {
            return DropdownMenuItem<String>(
              ...
              child: Text(
                ...
                style: hintStyle ?? CustomTextStyles.titleMediumInter,
              ),
            );
          }).toList(),
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.titleMediumInter,
        prefixIcon: prefix,
